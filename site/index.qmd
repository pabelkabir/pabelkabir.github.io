...
<section class="home-hero-panel" id="main-content">
  ...
  <figure class="home-hero-figure">
    <img src="assets/home/hero-aiim-hotspot.jpg" alt="AIIM hotspot density map and flavin-binding interaction diagram.">
    <figcaption>AIIM hotspot density map for a flavin-binding site showing the local environment that tunes photophysics and reactivity.</figcaption>
  </figure>
</section>
...
<section class="home-research-cards" aria-label="Research directions">
  <article class="home-research-card">
    ...
    <img class="home-card-figure" src="assets/home/photophysics-redshift.jpg" alt="Charge redistribution and protein environment diagram for flavin photophysics.">
  ...
  <article class="home-research-card">
    ...
    <img class="home-card-figure" src="assets/home/workflow-replicas.jpg" alt="Workflow diagram for molecular preparation, solvated replicas, MD sampling, and QM/MM branching.">
  ...
  <article class="home-research-card">
    ...
    <img class="home-card-figure" src="assets/home/polar-map.jpg" alt="Polar interaction density map for pyridine and methylammonium.">
...
<section class="home-info-grid" aria-label="Lab highlights">
  ...
  <article class="home-info-panel">
    ...
    <p>To apply or learn more, contact <a href="mailto:kabirm@savannahstate.edu">kabirm@savannahstate.edu</a>.</p>
